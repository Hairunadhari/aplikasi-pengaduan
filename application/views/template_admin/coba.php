										...
										<a class="dropdown-item" href="#">
											<div class="d-flex">
												<div class="flex-shrink-0 me-3">
													<div class="avatar avatar-online">
														<img src="<?= base_url('assets-admin/assets/img/avatars/1.png')?>"
											...
											<div class="card-body">
												<div
													...
													<div class="avatar flex-shrink-0">
														<img src="<?= base_url('assets-admin/assets/img/icons/unicons/chart-success.png')?>"
										...
										<div class="card">
											<div class="card-body">
												<div
													class="card-title d-flex align-items-start justify-content-between">
													<div class="avatar flex-shrink-0">
														<img src="<?= base_url('assets-admin/assets/img/icons/unicons/wallet-info.png')?>"
										...
										<div class="card">
											<div class="card-body">
												<div
													class="card-title d-flex align-items-start justify-content-between">
													<div class="avatar flex-shrink-0">
														<img src="<?= base_url('assets-admin/assets/img/icons/unicons/paypal.png')?>"
															alt="Credit Card" class="rounded" />
													</div>
													<div class="dropdown">
										...
										<div class="tab-content p-0">
											<div class="tab-pane fade show active" id="navs-tabs-line-card-income"
												...
												<div class="d-flex p-4 pt-3">
													<div class="avatar flex-shrink-0 me-3">
														<img src="<?= base_url('assets-admin/assets/img/icons/unicons/wallet.png')?>"
															alt="User" />
													</div>
													<div>
								...
								<div class="card h-100">
									...
									<div class="card-body">
										<ul class="p-0 m-0">
											...
											<li class="d-flex mb-4 pb-1">
												<div class="avatar flex-shrink-0 me-3">
													<img src="<?= base_url('assets-admin/assets/img/icons/unicons/chart.png')?>"
														alt="User" class="rounded" />
												</div>
												<div
													class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											...
											<li class="d-flex mb-4 pb-1">
												<div class="avatar flex-shrink-0 me-3">
													<img src="<?= base_url('assets-admin/assets/img/icons/unicons/cc-success.png')?>"
														alt="User" class="rounded" />
												</div>
												<div
													class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
											...
											<li class="d-flex">
												<div class="avatar flex-shrink-0 me-3">
													<img src="<?= base_url('assets-admin/assets/img/icons/unicons/cc-warning.png')?>"
														alt="User" class="rounded" />
												</div>
												<div
													class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
