					...
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="index.html" class="app-brand-link gap-2">
								...
								<span class="app-brand-text demo text-body fw-bolder">LAPOR !</span>
							</a>
						</div>
						<!-- /Logo -->
						<h4 class="mb-2  fw-bolder text-center">Daftar 🚀</h4>
						...
						<form id="formAuthentication" class="mb-3" action="<?= base_url('auth/daftar')?>" method="POST">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="telp" name="telp"
									placeholder="no telepon" autofocus />
							...
							<button type="submmit" class="btn btn-primary d-grid w-100">Registrasi</button>
						</form>
